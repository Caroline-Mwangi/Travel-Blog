...
export default function Antarctica() {
  ...
  const getAntarcticaPosts = async () => {
    const response = await axios.get(
      "http://127.0.0.1:8000/posts/?continent=Antarctica"
    );
  ...
  document.title = "Travel Blog | Antarctica ";
  return (
    <>
          ...
          <div class="carousel-inner">
            <div class="carousel-item active" data-bs-interval="5000">
              <div className="row">
                <div className="col-md-4">
                  <img
                    src="images/destinations/ant1.jpg"
                    className="d-block w-100"
                  />
                </div>
                <div className="col-md-4">
                  <img
                    src="images/destinations/ant2.jpg"
                    className="d-block w-100"
                  />
                </div>
                <div className="col-md-4">
                  <img
                    src="images/destinations/ant3.jpg"
                    className="d-block w-100"
                  />
                </div>
              </div>
            ...
            <div class="carousel-item " data-bs-interval="5000">
              <div className="row">
                <div className="col-md-4">
                  <img
                    src="images/destinations/ant4.jpg"
                    className="d-block w-100"
                  />
                </div>
                <div className="col-md-4">
                  <img
                    src="images/destinations/ant5.jpg"
                    className="d-block w-100"
                  />
                </div>
                <div className="col-md-4">
                  <img
                    src="images/destinations/ant6.jpg"
                    className="d-block w-100"
                  />
                </div>
              </div>
      ...
      <div className="container">
        <h1 className="fw-bold fs-1 text-center mt-4 mb-4">ANTARCTICA</h1>
