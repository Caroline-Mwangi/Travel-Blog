    ...
    <>
      <div className="container-fluid mt-5 mb-5">
          ...
          <div className="col-xl-7 col-lg-7 col-md-8 col-sm-6 col-xs-12 mt-3">
            <div>
              <p>
                ...
                <span className="pst-date">November 12, 2020</span>
              </p>
              ...
              <p className="pst-text">
                ...
                adipisci, et nobis blanditiis esse, omnis fuga. Doloremque
                maiores exercitationem blanditiis possimus adipisci repellat,
                fuga sequi. Lorem ipsum dolor sit amet consectetur adipisicing
                elit. Esse nihil quam, asperiores iste illum placeat nisi hic
                sint porro soluta molestias tempore ut pariatur doloremque
                assumenda consequuntur repudiandae ipsum eaque? Lorem ipsum
                dolor, sit amet consectetur adipisicing elit. Quos consectetur,
                culpa a sit laboriosam suscipit quidem obcaecati eligendi, vitae
                impedit saepe. Voluptas et laboriosam a velit perferendis rerum
                maxime optio...
              </p>
        ...
        <div className="row mb-5">
          ...
          <div className="col-xl-5 col-lg-5 col-md-4 col-sm-6 col-xs-12">
            <img src="images/post2.jpg" className="w-100 h-100 rounded" />
          </div>
        </div>

        <div className="row mb-5">
          <div className="col-xl-5 col-lg-5 col-md-4 col-sm-6 col-xs-12">
            <img src="images/post3.jpg" className="w-100 h-100 rounded" />
          </div>
          <div className="col-xl-7 col-lg-7 col-md-8 col-sm-6 col-xs-12 mt-3">
            <div>
              <p>
